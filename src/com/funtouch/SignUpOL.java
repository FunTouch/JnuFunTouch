...
public class SignUpOL extends Activity{
	...
	private List<Map<String, String>> ActDetail = new ArrayList<Map<String, String>>();
     ...
     StrictMode.setVmPolicy(new StrictMode.VmPolicy.Builder()
        ...
        if(listAct.get(0).getCode().equals("200"))
        {
			...
			adapter = new SimpleAdapter(this, listData, R.layout.lsv_enroll_act_raw,
					new String[] {"name", "info", "rest"},
					new int[] {R.id.enroll_act_name, R.id.enroll_act_info, R.id.enroll_act_rest});
